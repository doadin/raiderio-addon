...
-- All rights reserved.
--
local provider={name=...,data=3,region="tw",date="2023-06-20T08:48:45Z",numCharacters=30594,db={}}
local F
...
F = function() provider.db["日落沼澤"]={20,"冰火雙重天","十一顆","咖哩咖哩幽默","咖哩小尾巴","小壞","我爱看烟花","晴朗","灵犀","無尾熊之星","肉嘟嘟胖呼呼","花殤紫幽幽","阿戦","阿莱克斯莉萨","非正义的圣光"} end F()
F = function() provider.db["暗影之月"]={48,"Nazhock","Worchief","巨獸斬","狼魅妹"} end F()
