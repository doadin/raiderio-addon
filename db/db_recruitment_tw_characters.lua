...
-- All rights reserved.
--
local provider={name=...,data=3,region="tw",date="2022-12-26T07:05:29Z",numCharacters=22509,db={}}
local F
...
F = function() provider.db["憤怒使者"]={48,"扛麥郎習近平","鹹魚餅"} end F()
F = function() provider.db["語風"]={52,"Solozwarlock"} end F()
F = function() provider.db["水晶之刺"]={54,"Mikha","第三任期"} end F()
