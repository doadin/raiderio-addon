...
-- All rights reserved.
--
local provider={name=...,data=3,region="tw",date="2022-12-20T06:50:02Z",numCharacters=20380,db={}}
local F

F = function() provider.db["日落沼澤"]={0,"一條龍服務","冰火雙重天","心有灵犀","我爱看烟花","灵犀","無尾熊之星","肉嘟嘟胖呼呼","阿戦","阿莱克斯莉萨","非正义的圣光"} end F()
