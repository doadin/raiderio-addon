...
F = function() provider.db["暗影之月"]={62,"Chocomilk","Hingu","Lvdruid","Popcorns","Starlord","嘟嘟熊丶","東山再起氵","流砂","流砂誘惑","移動風怒圖騰","绝恋灬死神","辛玉原","龍鱗天生牙"} end F()
F = function() provider.db["眾星之子"]={88,"Rdwarrior","華笙"} end F()
F = function() provider.db["阿薩斯"]={92,"Lancelotery","Lazydragon","只為心中蒼穹"} end F()
F = function() provider.db["憤怒使者"]={98,"扛麥郎習特勒","維尼熊開坦克"} end F()
