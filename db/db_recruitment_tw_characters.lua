...
-- All rights reserved.
--
local provider={name=...,data=3,region="tw",date="2023-04-15T08:11:29Z",numCharacters=31648,db={}}
local F
...
F = function() provider.db["暗影之月"]={56,"Bakemono","Maievg","云宝黛西"} end F()
F = function() provider.db["寒冰皇冠"]={62,"善逸","時透無一郎"} end F()
